...
### data
serialize("res/paper/exp2/random-d-500.data", data)
data = deserialize("res/paper/exp2/random-d-500.data")
...
PyPlot.savefig("res/paper/exp2/random-d-500.pdf")
