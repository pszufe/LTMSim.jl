...
serialize("res/paper/exp1/random-d.data", data)
data = deserialize("res/paper/exp1/random-d.data")
...
xlabel(L"$d$", fontsize="x-large", fontweight="semibold", labelpad=10)

plt.tight_layout()

gcf()

PyPlot.savefig("res/paper/exp1/random-d.pdf")
